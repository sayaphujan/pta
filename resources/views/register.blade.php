	      ...
	      <div class="row">
	          <div class="col-lg-12">
                    <form method="POST" action="{{ route('signup') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('No. Telephone') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="level" class="form-control" id="level" aria-describedby="level">
                                    ...
                                    <option value="Admin Bidang" {{ old('level') == 'Admin Bidang' ? 'selected' : '' }}>Admin Bidang</option>
                                </select>    
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Kecamatan') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                 ...
                                 @if (Route::has('login'))
                                    <a class="btn btn-link" href="{{ url('/main/login/') }}">
                                        {{ __('Login') }}
                                    </a>
                                @endif
                            </div>
